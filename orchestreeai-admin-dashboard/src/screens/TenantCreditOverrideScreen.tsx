...
export const TenantCreditOverrideScreen: React.FC = () => {
  const { user } = useAuth();
  const [tenantId, setTenantId] = useState('tenant-enterprise-001');
        ...
        <div className="flex items-center space-x-3">
          ...
          <div className="flex items-center space-x-2">
            <input
              ...
              placeholder="e.g. tenant-enterprise-001"
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2">
            ...
            <h3 className="text-sm font-semibold text-slate-200">Riwayat Mutasi Kredit Ledger (Supabase PostgreSQL)</h3>
          </div>
