...
export const CommercialPlanManagementScreen: React.FC = () => {
  ...
  const [selectedTenantId, setSelectedTenantId] = useState('tenant-enterprise-001');
        ...
        <div className="flex items-center space-x-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-400">
              Single Source of Truth: Seluruh harga, alokasi kredit, dan batasan seat disinkronkan langsung ke Supabase PostgreSQL.
            </p>
          </div>
        </div>
