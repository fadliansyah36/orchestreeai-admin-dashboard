...
export const CANONICAL_PLANS: CanonicalPlanConfig[] = [
  {
    ...
    annualPriceIdr: 399000,
    description: 'Cocok untuk bisnis rintisan & UMKM yang ingin mengotomatiskan tugas harian staf inti.',
    aiWorkforceCount: 3,
    humanSeatsCount: 5,
    taskMonthlyLimit: '2.500 Tugas / Bulan',
    features: [
      '3 Staf AI Spesialis (Marketing, Sales, Copy)',
      'Hingga 5 Akun Staf Manusia',
  ...
  },
  {
    ...
    monthlyPriceIdr: 1499000,
    annualPriceIdr: 1199000,
    description: 'Untuk perusahaan bertumbuh yang membutuhkan orkestrasi lintas departemen penuh.',
    aiWorkforceCount: 8,
    humanSeatsCount: 20,
    taskMonthlyLimit: '15.000 Tugas / Bulan',
    isPopular: true,
    features: [
      '8 Staf AI Spesialis (Termasuk AI Chief of Staff & CFO)',
      'Hingga 20 Akun Staf Manusia',
  ...
  },
  {
    ...
    badge: 'Skala Lengkap',
    monthlyPriceIdr: 3499000,
    annualPriceIdr: 2799000,
    description: 'Untuk korporasi menengah yang membutuhkan otomatisasi autopilot multi-cabang.',
    aiWorkforceCount: 16,
    humanSeatsCount: 50,
    taskMonthlyLimit: '50.000 Tugas / Bulan',
    features: [
      '16 Staf AI Lengkap Seluruh Divisi',
  ...
  },
  {
    ...
    monthlyPriceIdr: 8999000,
    annualPriceIdr: 7199000,
