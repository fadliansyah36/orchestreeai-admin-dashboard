...
export const PricingSection: React.FC<PricingSectionProps> = ({ onSelectPlan }) => {
  ...
  const fetchPricing = async (showNotification = false) => {
    try {
      ...
      if (showNotification) {
        ...
        setSyncNotification(`Harga dan paket terbaru berhasil disinkronkan dari Backend Server & Supabase Database (${timeStr} WIB).`);
  ...
  return (
    <section id="pricing" className="py-24 bg-gradient-to-b from-[#071226] via-[#0B1835] to-[#071226] text-white border-t border-white/10 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="mt-4 text-sm sm:text-base text-slate-300 leading-relaxed">
            Pilih paket yang sesuai dengan tahapan bisnis Anda. Seluruh paket terhubung secara real-time ke Backend Server & Supabase Database untuk memastikan tarif transparan, isolasi multi-tenant terenkripsi, dan akses Company Brain.
          </p>

          {/* Real-time Backend Server & Supabase Status Header Bar */}
          <div className="mt-6 inline-flex flex-wrap items-center justify-center gap-2 p-2 rounded-2xl bg-white/[0.04] border border-white/10 backdrop-blur-md">
            <div className="flex items-center space-x-2 px-3 py-1 rounded-xl bg-emerald-950/60 border border-emerald-500/30 text-[11px] font-medium text-emerald-300">
              ...
              <span>Backend Server & Supabase Terhubung</span>
            </div>
            ...
            <button
              ...
              disabled={isSyncing}
              title="Sinkronkan pembaruan harga terbaru dari Backend Server dan Supabase"
          ...
          <div className="flex items-center space-x-4">
            ...
            <div>
              <h4 className="text-sm sm:text-base font-bold text-white">
                Garansi Keamanan Kedaulatan Data & Integrasi Supabase Terisolasi
              </h4>
              <p className="text-xs sm:text-sm text-slate-400 mt-0.5">
                Setiap data tenant dienkripsi dengan kunci terpisah (AES-256), Row-Level Security (RLS) di Supabase, dan cadangan otomatis harian.
              </p>
            </div>
          </div>
          <button
      ...
      {/* Backend & Supabase Diagnostic / Price Simulation Modal */}
      {showDiagnosticModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fadeIn">
          <div className="bg-[#0B1835] border border-white/15 rounded-3xl max-w-xl w-full p-6 text-white shadow-2xl relative">
            ...
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Status Integrasi Backend Server & Supabase</h3>
            ...
            <div className="space-y-2.5 text-xs font-mono bg-black/40 p-4 rounded-2xl border border-white/10 mb-5">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-blue-400 font-semibold">{syncMetadata?.supabaseUrl || 'https://exfvfyiwftywqjcsofgf.supabase.co'}</span>
              </div>
              <div className="flex justify-between items-center">
              ...
              <div className="flex justify-between items-center">
                ...
                <span className="text-yellow-300 font-semibold uppercase">{syncMetadata?.source || 'backend_api / supabase'}</span>
              </div>
              <div className="flex justify-between items-center">
